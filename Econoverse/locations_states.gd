...
#@onready var locations = {
	...
	#BaseState.locations.Brewhouse: $Brewhouse,
	#BaseState.locations.Masonic_Shop: $Masonic_Shop,
	#BaseState.locations.Tannery: $Tannery,
	#BaseState.locations.Town_Square: $Town_Square
#}
