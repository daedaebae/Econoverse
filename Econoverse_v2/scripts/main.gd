...
var Player = player.new("Player",7,1,"Human",0,{"Sword": 0, "Strudel": 0, "Coins": 0}, false)
#var Player = player.new("Iona",7,1,"Human",0,{"Sword": 0, "Strudel": 0, "Coins": 5}, false)
...
func _ready() -> void:
	...
	var Items = preload("res://scripts/Items.json")
